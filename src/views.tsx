...
const taskListView = (a: I.IApp, stla: I.ISearchTaskListActivity) =>
...
const taskListActivityView = (a: I.IApp, tla: I.ITaskListActivity) =>
...
const associateLabelList = (a: I.IApp, labels: SArrayType<I.ILabel>) =>
    labels.map(l =>
        <span className="label"
              style={labelInlineStyle(l)}
